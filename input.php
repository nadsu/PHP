...
<form method="POST" action="hasilkirim.php"> 
    <table align="center" cellpadding="2" cellspacing="2">
        <h1 id="font1"> FORUM DATA </h1>
        <tr>
            <td width="130" style="font-size: 20px;"> Email </td>
            <td> <input id="kolom" type="text" name="email"> </td>
        </tr>
        <tr>
            <td width="130" style="font-size: 20px;"> Nama </td>
            <td> <input id="kolom" type="text" name="nama"> </td>
        </tr>
        <tr>
            <td colspan="2" align="center">
                <input id="button" type="submit" name="btnlogin" value="Kirim">
